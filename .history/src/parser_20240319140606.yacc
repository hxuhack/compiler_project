...
{
  $$ = A_ArrayExprUnit($1->pos, A_ArrayExpr($1->pos, $1->A_IdIndexExpr($1->pos, $1->id), A_IdIndexExpr($3->pos, $3->id))); 
}
| ID OPENBRACKET NUM CLOSEBRACKET
{
  $$ = A_ArrayExprUnit($1->pos, A_ArrayExpr($1->pos, $1->A_IdIndexExpr($1->pos, $1->id), A_NumIndexExpr($3->pos, $3->num))); 
}
| ID DOT ID
{
